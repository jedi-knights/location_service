"""
This module contains the functionality to seed the database with initial data.
"""
...
locations = [
    ...
    ('456 Broadway', 2, 2),
    ('789 Yonge St', 3, 3),
    ('321 Saint Laurent Blvd', 4, 4),
    ('654 Lopez Mateos Ave', 5, 5),
    ('987 Garza Sada Ave', 6, 6)
]
...
if __name__ == "__main__":
    ...
    QUERY = "INSERT INTO locations (address, postal_code_id, city_id) VALUES (%s, %s, %s)"
    cur.executemany(QUERY, locations)
